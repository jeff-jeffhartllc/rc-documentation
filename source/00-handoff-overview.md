...
1. **Scorecard / dimension PDP** — Daily Sales Master 2 and domo_regis.MonthlyMetrics PDP are documented. Store Scorecard Data, DimSalon, and related ETL outputs still need PDP tab verification.
